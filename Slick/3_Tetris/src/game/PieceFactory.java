...
public class PieceFactory {
	...
	public Piece generateRandomPiece() {
		...
		case 0:
			return generatePiece('t');
		case 1:
			return generatePiece('s');
		case 2:
			return generatePiece('z');
		case 3:
			return generatePiece('o');
		case 4:
			return generatePiece('i');
		case 5:
			return generatePiece('l');
		case 6:
			return generatePiece('j');
		}
	...
	static Tuple[][] TRotationMatrice = {
			{ new Tuple(0, 0), new Tuple(-1, 0), new Tuple(1, 0),
					new Tuple(0, -1) },
			{ new Tuple(0, 0), new Tuple(0, 1), new Tuple(0, -1),
					new Tuple(-1, 0) },
			{ new Tuple(0, 0), new Tuple(1, 0), new Tuple(-1, 0),
					new Tuple(0, 1) },
			{ new Tuple(0, 0), new Tuple(0, -1), new Tuple(0, 1),
	...
	static Tuple[][] SRotationMatrice = {
			{ new Tuple(0, 0), new Tuple(1, 0), new Tuple(0, -1),
					new Tuple(-1, -1) },
			{ new Tuple(0, 0), new Tuple(0, 1), new Tuple(1, 0),
					new Tuple(1, -1) },
			{ new Tuple(0, 0), new Tuple(1, 0), new Tuple(0, -1),
					new Tuple(-1, -1) },
			{ new Tuple(0, 0), new Tuple(0, 1), new Tuple(1, 0),
