...
import mainGame.tools.AbstractEntity;
...
public class Crate extends AbstractEntity {
	...
	/**
	 * @see mainGame.tools.Entity#getBody()
	 */
	public Body getBody() {
		return body;
	}
	...
	/**
	 * @see mainGame.tools.Entity#preUpdate(int)
	 */
	public void preUpdate(int delta) {
	}

	/**
	 * @see mainGame.tools.Entity#render(org.newdawn.slick.Graphics)
	 */
	...
	/**
	 * @see mainGame.tools.Entity#setWorld(net.phys2d.raw.World)
	 */
	...
	/**
	 * @see mainGame.tools.Entity#update(int)
	 */
