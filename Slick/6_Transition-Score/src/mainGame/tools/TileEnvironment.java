...
public class TileEnvironment extends AbstractEnvironment {
	...
	/**
	 * @see mainGame.tools.Environment#getBounds()
	 */
	...
	/**
	 * @see mainGame.tools.Environment#render(org.newdawn.slick.Graphics)
	 */
	...
	/**
	 * @see mainGame.tools.Environment#renderBounds(org.newdawn.slick.Graphics)
	 */
